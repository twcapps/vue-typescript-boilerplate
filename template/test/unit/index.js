...
const testsContext = require.context('../../src', true, /\.spec$/){{#if_eq lintConfig "airbnb"}};{{/if_eq}}
...
const srcContext = require.context('../../src', true, /^\.\/(?!main\.ts$).+\.(ts|vue)$/i){{#if_eq lintConfig "airbnb"}};{{/if_eq}}
